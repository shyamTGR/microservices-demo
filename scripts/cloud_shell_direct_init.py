#!/usr/bin/env python3
"""
Direct AlloyDB initialization script for Cloud Shell
This script connects directly to AlloyDB and initializes the database with products and embeddings.
"""
...
def get_alloydb_password():
    ...
    try:
        ...
        logger.info("Please provide the AlloyDB password manually:")
        return input("AlloyDB Password: ").strip()
...
def init_database():
    ...
    # First connect to postgres database to create products database if needed
